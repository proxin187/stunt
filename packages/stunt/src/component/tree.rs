...
/// PathBuilder keeps track of the path in both the virtual dom, and the intermediate
/// representation generated by the html macro
...
impl ComponentRef {
    ...
    pub(crate) fn render(
        ...
        match self {
            ...
            ComponentRef::Template(template) => Node::new(callbacks, template.template(path.clone(), scope.clone()), path.virt, scope),
